    ...
    def load(self):
        ...
        for seasonId in self._app.handler.get_seasons():
            ...
            for tournament_name in season.tournaments():
                ...
                self._menu[seasonVar+"_select_"+tournament_name].update({ seasonVar+"_select_"+tournament_name+"_difficlty": "View Difficulty", seasonVar+"_select_"+tournament_name+"_prizemoney": "View Prize Money" })
                self._menu[seasonVar+"_select_"+tournament_name+"_difficulty"] = partial(season.display, "difficulty", tournament_name)
                self._menu[seasonVar+"_select_"+tournament_name+"_prizemoney"] = partial(season.display, "prizemoney", tournament_name)
