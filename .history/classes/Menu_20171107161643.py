...
class Menu():
    ...
    def load(self):
        ...
        self._menu['back'] = lambda: goBack()
        self._menu['ns_players'] = { "ns_viewplayers": "View Players", "ns_viewplayer": "View Player" }
        self._menu['ns_tournaments'] = { "ns_viewtournaments": "Example Tournament 1" }
        self._menu['ns_prizemoney'] = { "ns_setprizemoney": "Set Prize Money", "ns_viewprizemoney": "View Prize Money" }
        self._menu['ns_difficulty'] = { "ns_setdifficulty": "Set Difficulty", "ns_viewdifficulty": "View Difficulty" }
