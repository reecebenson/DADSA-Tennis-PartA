    ...
    def load(self):
        ...
        for seasonId in self._app.handler.get_seasons():
            ...
            for tournament_name in season.tournaments():
                ...
                self._menu[tournamentVar+"_difficulty"] = partial(print, lambda: season.tournament(tournament_name).display("difficulty"))
                self._menu[tournamentVar+"_prizemoney"] = partial(print, lambda: season.tournament(tournament_name).display("prize_money"))
