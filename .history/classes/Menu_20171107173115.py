...
class Menu():
    ...
    def load(self):
        ...
        for seasonId in self._app.handler.get_seasons():
            ...
            self._menu[seasonVar] = { seasonVar+"_select": "Select Tournament", seasonVar+"_players": "View Players", seasonVar+"_prizemoney": "View Prize Money", seasonVar+"_details": "View Details", "back": "Back" }
