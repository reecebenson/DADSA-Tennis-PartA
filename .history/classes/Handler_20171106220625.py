...
class Handler():
        ...
        with open('./data/seasons.json') as tData:
            ...
            for season in data:
                ...
                if(not season in self.get_seasons()):
                    self.seasons.update({ season: Season.Season(self.app, season) })
            ...
            for season in data:
                ...
                for gender in data[season]:
                    ...
                    for player in data[season][gender]:
                        ...
                        self.get_season(season).players[gender].append(player)
    ...
    # Return the players within the specified season
    def get_players(self, season):
        ...
        if(not season in self.seasons):
            ...
            if(self.seasons[season].players):
