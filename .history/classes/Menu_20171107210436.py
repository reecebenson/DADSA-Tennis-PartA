            ...
            for tournament_name in season.tournaments():
                ...
                for gdr in season.rounds():
                    ...
                    for rnd in season.rounds()[gdr]:
                        self._menu[tournamentVar+"_"+gdr].update({ tournamentVar+"-"+gdr+"-"+rnd: "Round {0}".format(rnd) })
                        self._menu[tournamentVar+"-"+gdr+"-"+rnd] = partial(print, season.tournament(tournament_name).round(rnd))
