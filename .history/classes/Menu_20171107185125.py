            ...
            for tournament_name in season.tournaments():
                ...
                for gdr in season.rounds():
                    ...
                    for rnd in season.rounds()[gdr]:
                        ...
                        self._menu[seasonVar+"_select_"+tournament_name+"_"+gdr+"_"+rnd] = lambda: print("view round {0} of {1} [{2}] --- {3}".format(rnd, gdr, seasonVar+"_select_"+tournament_name+"_"+gdr+"_"+rnd, self._current_menu))
