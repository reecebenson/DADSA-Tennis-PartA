    ...
    def load(self):
        ...
        for seasonId in self._app.handler.get_seasons():
            ...
            for tournament_name in season.tournaments():
                ...
                self._menu[seasonVar+"_select_"+tournament_name+"_difficulty"] = partial(tournament.display, "difficulty")
                self._menu[seasonVar+"_select_"+tournament_name+"_prizemoney"] = partial(tournament.display, "prizemoney")
